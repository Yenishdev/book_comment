            ...
            <form
                ...
                <div class="my-2 bg-grey-lighter">
                    ...
                    <div class="my-2">
                        ...
                        <input type="text" name="theme" placeholder="Theme Of Book">
                    </div>
                    <div class="my-2 ps-5">

                        <textarea name="comment" id="" cols="50" rows="5" placeholder="Your comment" class="ms-5"></textarea>
                    </div>
                    <div class="my-2">
                        <label for="pages" class="mx-1">Pages:</label>
                        <input type="number" name="pages" placeholder="How many Pages">
                    </div>
                    <div >
